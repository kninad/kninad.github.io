...
%.html: %.md
	...
	@pandoc --template=./static/html/template.html --lua-filter=./static/links-to-html.lua -c ./static/css/pandoc.css -B ./static/html/navbar_L1.html --mathjax -f markdown -t html5 --standalone -i $(TEMPFILE) -o $@
	@rm -f $(TEMPFILE)
